...
def main():
    ...
    def selectItem():
        ...
        promptProducts()  # Print PRODUCTS DATABASE
    ...
    def changePrice():
        while True:
            ...
            menuControl(var)  # checks Control Flow.
            if var.lower() == "y":
                try:
                    modify_item = modify_products.getInput("Which item would you like to change?:")
                    menuControl(modify_item)  # checks Control Flow.
                    ...
                    menuControl(new_value)  # checks Control Flow.
